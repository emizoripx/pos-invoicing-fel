                ...
                <form method="POST" action="{{ route('felrestorant.updatesettings', $fel_restorant->id) }}" >
                    ...
                    <div class="row">
                        @include('partials.fields',['fields'=>[
                            ...
                            ['class'=>'col-6', 'ftype'=>'input', 'placeholder' => 'Template de Factura', 'name'=>"Template de Factura",'id'=>"template_invoice",'required'=>false, 'value'=> isset($fel_restorant->settings['template_invoice']) ? $fel_restorant->settings['template_invoice'] :  null],
