@if($invoice->codigoEstado == 690)
  ...
  @endif
@elseif($invoice->estado == "RECHAZADA")

  <button type="button" class="btn btn-sm bg-warning text-white" onclick="showOrHideErrosModal( true, {{ $invoice }})">  {{ __('Ver Error') }}</button>
